...
{\textbf{\Large{Xây dựng hệ thống tư vấn pháp luật tài chính Nhật Bản sử dụng RAG và Knowledge Graph}}\\[1cm]

{\textbf{\large{PHẠM QUỐC CƯỜNG}}}\\
{\large{20225604}} \\
{\large{cuong.pq225604@sis.hust.edu.vn}}\\[0.5cm]
...
\resizebox{\textwidth}{!}{%
\begin{tabular}{ll}
\multicolumn{1}{c}{\textbf{Giảng viên hướng dẫn:}} & TS. Trịnh Tuấn Đạt \hspace{0.5cm} \underline{\hspace{3cm}}  \\[0.5cm]
