...
\usepackage{parskip}
\usepackage{CJKutf8}
\newcommand{\japan}[1]{\begin{CJK}{UTF8}{min}#1\end{CJK}}
...
\def \TITLE{BÁO CÁO ĐỒ ÁN GR2}
\def \AUTHOR{PHẠM QUỐC CƯỜNG}
...
\subfile{Chuong/C1_Tong_quan} % Phần mở đầu

\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{CƠ SỞ LÝ THUYẾT}
\label{chapter:Related_works}
\subfile{Chuong/C2_Co_so_ly_thuyet}
...
\subfile{Chuong/C3_Thiet_ke_he_thong}

\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{TRIỂN KHAI HỆ THỐNG}
\label{chapter:Experiment}
\subfile{Chuong/C4_Trien_khai_he_thong}

\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{ĐÁNH GIÁ}
\label{chapter:SolutionAndContribution}
\subfile{Chuong/C5_Danh_gia}

\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{KẾT LUẬN VÀ HƯỚNG PHÁT TRIỂN}
\label{chapter:FutureWork}
\subfile{Chuong/C6_Huong_phat_trien}
